...
@if($fillableColumn === "created_by_admin_user_id")use Aligilani\Craftable\Traits\CreatedByAdminUserTrait;
@elseif($fillableColumn === "updated_by_admin_user_id")use Aligilani\Craftable\Traits\UpdatedByAdminUserTrait;
@endif
@endforeach
@endif
...
@endif
@if($translatable->count() > 0)use Aligilani\Translatable\Traits\HasTranslations;
@endif
