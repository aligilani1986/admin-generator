...
use Aligilani\AdminGenerator\Generate\Traits\FileManipulations;
        ...
        return view('brackets/admin-generator::' . $this->view, [
            ...
            'columnsToQuery'                => $this->readColumnsFromTable($this->tableName)->filter(function ($column) {
                if ($this->readColumnsFromTable($this->tableName)->contains('name', 'created_by_admin_user_id')) {
                    return !('text' == $column['type'] || "password" == $column['name'] || "remember_token" == $column['name'] || "slug" == $column['name'] || "updated_at" == $column['name'] || "deleted_at" == $column['name']);
                } else if ($this->readColumnsFromTable($this->tableName)->contains('name', 'updated_by_admin_user_id')) {
                    return !('text' == $column['type'] || "password" == $column['name'] || "remember_token" == $column['name'] || "slug" == $column['name'] || "created_at" == $column['name'] || "deleted_at" == $column['name']);
                    ...
                    return !('text' == $column['type'] || "password" == $column['name'] || "remember_token" == $column['name'] || "slug" == $column['name'] || "deleted_at" == $column['name']);
                }
                return !('text' == $column['type'] || "password" == $column['name'] || "remember_token" == $column['name'] || "slug" == $column['name'] || "created_at" == $column['name'] || "updated_at" == $column['name'] || "deleted_at" == $column['name']);
            })->pluck('name')->toArray(),
            'columnsToSearchIn'             => $this->readColumnsFromTable($this->tableName)->filter(function ($column) {
                return ('json' == $column['type'] || 'text' == $column['type'] || 'string' == $column['type'] || "id" == $column['name']) && !("password" == $column['name'] || "remember_token" == $column['name']);
            })->pluck('name')->toArray(),
