...
trait Helpers {
    ...
    public function option($key = null) {
        return (null === $key || $this->hasOption($key)) ? parent::option($key) : null;
    }
    ...
    public function setBelongToManyRelation($belongsToMany) {
        $this->relations['belongsToMany'] = collect(explode(',', $belongsToMany))->filter(function ($belongToManyRelation) {
            ...
            return [
                ...
                'related_model'               => ('roles' == $belongsToMany) ? "Spatie\\Permission\\Models\\Role" : "App\\Models\\" . Str::studly(Str::singular($belongsToMany)),
                'related_model_class'         => ('roles' == $belongsToMany) ? "Spatie\\Permission\\Models\\Role::class" : "App\\Models\\" . Str::studly(Str::singular($belongsToMany)) . '::class',
